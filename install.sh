...
packages_install(){
    ...
    apt-get install -y --force-yes git > /dev/null 2>&1
    apt-get install -y --force-yes php7.0  > /dev/null 2>&1
...
fos_install(){
    ...
    /bin/cp improvement/www.conf /home/fos-streaming/fos/php/etc/php-fpm.d/www.conf
...
echo "IPTV-MD Se instaleaza, Asteapta..."
