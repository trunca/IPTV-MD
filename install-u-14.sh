...
fos_install(){
    ...
    wget https://downloads.sourceforge.net/project/iptv-md/upload/fos-streaming_unpack_x84_64.tar.gz -O /home/fos-streaming/fos-streaming_unpack_x84_64.tar.gz > /dev/null 2>&1
...
ffmpeg()
{
    wget https://github.com/trunca/ffmpg/raw/master/ffmpeg-release-64bit-static.tar.xz -O /home/fos-streaming/ffmpeg-release-64bit-static.tar.xz  > /dev/null 2>&1
...
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │[+]        IPTV se instaleaza. Asteptam...                │ \e[0m"
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
